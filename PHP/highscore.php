...
<div id = "startmenu" >
  ...
  <table id="navbar">
  <tr>
    <td> <a onmousedown="$('.records').hide(); $(longtimetable).show();" >
Longest Time</a></td>
    <td> <a onmousedown="$('.records').hide(); $(shorttimetable).show();">
Shortest Time</a></td>
    <td> <a onmousedown="$('.records').hide(); $(correcttable).show();">
Most Correct</a></td>
    <td> <a onmousedown="$('.records').hide(); $(longcorrecttable).show();" >
Longest Time and Most Correct</a></td>
    <td> <a onmousedown="$('.records').hide(); $(shortcorrecttable).show();">
Fastest Average with Most Correct</a></td>
  </tr>
</table>
    <div id="longestTime">
      <table >
        <tbody>
            <tr class="panelheader"><th colspan="4">Top Members</th></tr>
                <tr class="panelsubheader"><td>Rank</td><td>Member</td><td>Points</td><td>Time</td></tr></table>
       <?php
